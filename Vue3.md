...
- setup的参数
  ...
  <script>
     ...
     export default {
        ...
        emits:['hello'],
        setup(props,context){
           // console.log('---setup---',props) //Proxy{msg: "你好啊", school: "vue"}
           // console.log('---setup---',context) //{expose: f}
           // console.log('---setup---',context.attrs) //相当与Vue2中的$attrs,props中没有声明接收的属性回到attrs中去
